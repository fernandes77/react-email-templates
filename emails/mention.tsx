...
export const MentionEmail = ({
  ...
  <Html>
    <Head />
    <Preview>You were mentioned in {commentPlace}</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={box}>
          ...
          <Text style={description}>
            <b style={bold}>{commenterName}</b> mentioned you in a comment on{" "}
...
MentionEmail.PreviewProps = {
  commentMessage:
    "@You I was thinking that there should be “properties” tab in the menu because the only way to search is by going to the spot on the page where it says search on the home page but not in the menu.",
