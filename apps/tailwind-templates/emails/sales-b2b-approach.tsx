...
interface SalesB2BApproachProps {
...
export const SalesB2BApproachEmail = ({
  salesPersonName,
  salesPersonOccupation,
  salesPersonAvatar,
  calendarLink,
  recipientName,
}: SalesB2BApproachProps) => (
  <Html>
    <Head />
    <Preview>{recipientName}, check out how to be even more successful</Preview>
    <Body style={main}>
...
SalesB2BApproachEmail.PreviewProps = {
  recipientName: "John",
...
} as SalesB2BApproachProps;

export default SalesB2BApproachEmail;
